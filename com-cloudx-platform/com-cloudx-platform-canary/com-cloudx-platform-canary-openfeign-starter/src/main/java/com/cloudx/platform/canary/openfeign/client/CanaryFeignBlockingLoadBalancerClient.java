package com.cloudx.platform.canary.openfeign.client;

import static com.cloudx.platform.canary.openfeign.client.LoadBalancerUtils.executeWithLoadBalancerLifecycleProcessing;
...
public class CanaryFeignBlockingLoadBalancerClient implements Client {
    ...
    public Response execute(Request request, Request.Options options) throws IOException {
        ...
        CanaryRequest<RequestDataContext> lbRequest = new CanaryRequest<>(new RequestDataContext(LoadBalancerUtils.buildRequestData(request), hint));
