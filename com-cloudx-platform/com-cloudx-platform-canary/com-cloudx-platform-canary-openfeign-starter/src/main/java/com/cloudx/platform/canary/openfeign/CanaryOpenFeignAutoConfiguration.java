package com.cloudx.platform.canary.openfeign;

import com.cloudx.platform.canary.openfeign.client.CanaryFeignBlockingLoadBalancerClient;
import com.cloudx.platform.canary.openfeign.interceptor.CanaryHttpInterceptor;
import feign.Client;
