...
/**
 * Represents a cached implementation of {@link UidGenerator} extends from {@link DefaultUidGenerator}, based on a lock free {@link RingBuffer}<p>
 * <p>
 ...
 * threshold, it will trigger padding buffer. Default as{@link RingBuffer#DEFAULT_PADDING_PERCENT} Sample: paddingFactor=20, bufferSize=1000 -> threshold=1000 * 20 /100, padding buffer will be
